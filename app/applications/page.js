                ...
                <CardHeader>
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      ...
                      <CardDescription>
                        {application.college_name} • Applied on {new Date(application.applied_at).toLocaleDateString()}
                      </CardDescription>
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="flex items-center text-gray-500">
                      ...
                      <span className="text-sm">
                        Applied {Math.floor((new Date() - new Date(application.applied_at)) / (1000 * 60 * 60 * 24))}{" "}
                        days ago
                      </span>
                    </div>
                  </div>
